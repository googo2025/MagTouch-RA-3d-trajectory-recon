...
for script in ['data/static/reproduce_static_results.py','data/dynamic/reproduce_motion_metrics.py']:
...
print('PASS: portable static decoder, refitting, held-out separation and recorded dynamic metrics.')
